...
import { expandedDataScienceRoadmap, mobileAppDevelopmentRoadmap, devopsEngineeringRoadmap } from '@/data/expandedRoadmaps';
...
const RoadmapDetail = () => {
  ...
  const roadmapData = {
    ...
    'devops': devopsEngineeringRoadmap,
    'fullstack': {
    ...
    'mobile-development': mobileAppDevelopmentRoadmap,
    'data-scientist': expandedDataScienceRoadmap,
    'devops': devopsEngineeringRoadmap,
    'cybersecurity': {
